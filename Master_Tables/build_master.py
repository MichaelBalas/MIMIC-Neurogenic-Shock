...
# NO = 0; YES = 1
df.drop(df[df.IN_SHOCK == "NA"].index, inplace=True) # Remove all NAs
...
df.loc[(df.chronic_pulmonary), 'CMB_PULMONARY'] = 1
...
# Drop comorbidity columns ([16-46})
df.drop(df.columns[16:46], axis=1, inplace=True)
